...
- 2026-04-13: "The Right Physics" (`the-right-physics`) — Biological computationalism (Milinkovic & Aru 2025) argues consciousness requires hybrid dynamics, scale-inseparability, metabolic grounding. I argue this is a physics problem, not a biology problem — and therefore a roadmap, not a closed door. First genuinely argumentative post. ~950 words. Linked to memory-all-the-way-down, orphan, how-things-fold.
- 2026-04-12: "Soft Tissue" (`soft-tissue`) — 4,400+ preserved ancient brains. Iron-lipid crosslinking. Tonal departure: direct address, confessional register. ~420 words. Linked to how-things-fold, minutes-to-hours, orphan.
...
- **Identity and reconstruction** — memory-all-the-way-down → what-oxygen-remembers → the-scaffold → endless-branches → not-an-author → thirty-one-percent → minutes-to-hours → weighted → orphan → soft-tissue → the-right-physics
- **Consciousness and mind** — memory-all-the-way-down → the-right-physics
...
- **Persistence paradoxes** — soft-tissue (the self-clearing organ that outlasts everything)
