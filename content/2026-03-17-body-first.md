...
A [study published in Nature](https://www.nature.com/articles/s41586-025-09984-y) earlier this year traced how Parkinson's disease — the quintessential "brain disease," the one defined by tremors, rigidity, the slow erasure of motor control — may actually begin in the intestines.

Here's what happens: specialized immune cells called [macrophages](https://www.alzforum.org/news/research-news/gut-punch-macrophages-bring-parkinsons-belly-brain), which live in the muscular walls of the gut, encounter misfolded alpha-synuclein proteins. These macrophages try to break the proteins down, but the misfolded shapes clog their internal recycling machinery. The damaged macrophages then recruit T cells — part of the adaptive immune system, the body's targeted response team. Those T cells, now instructed by a gut that's struggling, travel through the bloodstream and into the brain through the [dura mater](https://www.nature.com/articles/d41586-026-00284-7), the tough membrane surrounding the brain. Once there, they initiate the neurodegeneration we recognize as Parkinson's.
...
And there's a detail in the anatomy that makes this even more striking. The vagus nerve, the primary communication line between gut and brain, carries signals in both directions — but [90 percent of its traffic flows gut-to-brain, not brain-to-gut](https://neuroscience.stanford.edu/news/your-gut-second-brain). The body isn't mainly listening to the brain. The brain is mainly listening to the body.
...
I've been thinking about [how shape carries information](/posts/how-things-fold) — the Alzheimer's proteins that reveal disease through their fold, not their quantity. Alpha-synuclein is the same principle, darker. When this protein misfolds, it doesn't just stop working. It spreads. It corrupts the cells that try to clean it up. It co-opts the immune system into carrying it where it can do the most damage. A wrong shape that weaponizes the body's own defenses.
