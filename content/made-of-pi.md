...
And π is the most famous number with none of those properties. Its digits are, for all practical purposes, random. No algorithm can compress them. No formula can shortcut them. You have to compute each digit the hard way, and you can compute as many as you want — [the record is 202 trillion](https://cloud.google.com/blog/products/compute/calculating-100-trillion-digits-of-pi) — without ever reaching a point where the sequence settles into a loop.
